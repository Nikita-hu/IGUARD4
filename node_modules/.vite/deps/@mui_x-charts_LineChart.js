import {
  NoSsr_default,
  Popper_default
} from "./chunk-5FQ7KJ6R.js";
import {
  useThemeProps
} from "./chunk-N5TBY7A6.js";
import {
  Typography_default
} from "./chunk-CLVXWQ7C.js";
import {
  useTheme
} from "./chunk-2LECZQJZ.js";
import "./chunk-Y5YNJLJR.js";
import {
  require_react_dom
...
} from "./chunk-ZZR4N74G.js";
import "./chunk-O47O4NPH.js";
import {
...
var Path = class {
  ...
  arcTo(x1, y1, x2, y2, r3) {
    ...
    if (this._x1 === null) {
      ...
      let x20 = x2 - x0, y20 = y2 - y0, l21_2 = x21 * x21 + y21 * y21, l20_2 = x20 * x20 + y20 * y20, l21 = Math.sqrt(l21_2), l01 = Math.sqrt(l01_2), l = r3 * Math.tan((pi2 - Math.acos((l21_2 + l01_2 - l20_2) / (2 * l21 * l01))) / 2), t01 = l / l01, t21 = l / l21;
  ...
  arc(x2, y2, r3, a0, a1, ccw) {
    ...
    if (da > tauEpsilon) {
      ...
      this._append`A${r3},${r3},0,${+(da >= pi2)},${cw},${this._x1 = x2 + r3 * Math.cos(a1)},${this._y1 = y2 + r3 * Math.sin(a1)}`;
    }
  }
  rect(x2, y2, w, h) {
...
function controlPoints(x2) {
  var i, n = x2.length - 1, m, a2 = new Array(n), b = new Array(n), r3 = new Array(n);
  a2[0] = 0, b[0] = 2, r3[0] = x2[0] + 2 * x2[1];
  for (i = 1; i < n - 1; ++i) a2[i] = 1, b[i] = 4, r3[i] = 4 * x2[i] + 2 * x2[i + 1];
  a2[n - 1] = 2, b[n - 1] = 7, r3[n - 1] = 8 * x2[n - 1] + x2[n];
  for (i = 1; i < n; ++i) m = a2[i] / b[i - 1], b[i] -= m, r3[i] -= m * r3[i - 1];
  a2[n - 1] = r3[n - 1] / b[n - 1];
  for (i = n - 2; i >= 0; --i) a2[i] = (r3[i] - a2[i + 1]) / b[i];
  b[n - 1] = (x2[n] + a2[n - 1]) / 2;
...
function rgba(r3, g, b, a2) {
  if (a2 <= 0) r3 = g = b = NaN;
  return new Rgb(r3, g, b, a2);
}
...
function hslConvert(o) {
  ...
  o = o.rgb();
  var r3 = o.r / 255, g = o.g / 255, b = o.b / 255, min3 = Math.min(r3, g, b), max3 = Math.max(r3, g, b), h = NaN, s2 = max3 - min3, l = (max3 + min3) / 2;
  if (s2) {
    if (r3 === max3) h = (g - b) / s2 + (g < b) * 6;
    else if (g === max3) h = (b - r3) / s2 + 2;
    else h = (r3 - g) / s2 + 4;
...
function labConvert(o) {
  ...
  var r3 = rgb2lrgb(o.r), g = rgb2lrgb(o.g), b = rgb2lrgb(o.b), y2 = xyz2lab((0.2225045 * r3 + 0.7168786 * g + 0.0606169 * b) / Yn), x2, z;
  if (r3 === g && g === b) x2 = z = y2;
  else {
    x2 = xyz2lab((0.4360747 * r3 + 0.3850649 * g + 0.1430804 * b) / Xn);
...
function cubehelixConvert(o) {
  ...
  if (!(o instanceof Rgb)) o = rgbConvert(o);
  var r3 = o.r / 255, g = o.g / 255, b = o.b / 255, l = (BC_DA * b + ED * r3 - EB * g) / (BC_DA + ED - EB), bl = b - l, k2 = (E * (g - l) - C * bl) / D, s2 = Math.sqrt(k2 * k2 + bl * bl) / (E * l * (1 - l)), h = s2 ? Math.atan2(k2, bl) * degrees - 120 : NaN;
...
var rgb_default = function rgbGamma(y2) {
  ...
  function rgb3(start2, end) {
    var r3 = color3((start2 = rgb(start2)).r, (end = rgb(end)).r), g = color3(start2.g, end.g), b = color3(start2.b, end.b), opacity = nogamma(start2.opacity, end.opacity);
    return function(t) {
      start2.r = r3(t);
      start2.g = g(t);
      start2.b = b(t);
...
function rgbSpline(spline) {
  return function(colors3) {
    var n = colors3.length, r3 = new Array(n), g = new Array(n), b = new Array(n), i, color3;
    for (i = 0; i < n; ++i) {
...
function polymap(domain, range2, interpolate2) {
  ...
  while (++i < j) {
    ...
    r3[i] = interpolate2(range2[i], range2[i + 1]);
  }
  return function(x2) {
    var i2 = bisect_default(domain, x2, 1, j) - 1;
    return r3[i2](d[i2](x2));
  };
}
...
function StyledEngineProvider(props) {
  ...
  return injectFirst && cache ? (0, import_jsx_runtime30.jsx)(CacheProvider, {
    value: cache,
    children
  }) : children;
}
...
var elementAcceptingRef = chainPropTypes(import_prop_types26.default.element, acceptingRef);
elementAcceptingRef.isRequired = chainPropTypes(import_prop_types26.default.element.isRequired, acceptingRef);
...
var elementTypeAcceptingRef_default = chainPropTypes(import_prop_types27.default.elementType, elementTypeAcceptingRef);
...
var ThemeContext2 = React82.createContext(null);
if (true) {
...
function useTheme4() {
  const theme = React83.useContext(ThemeContext_default);
  if (true) {
...
function ThemeProvider2(props) {
  ...
  return (0, import_jsx_runtime36.jsx)(ThemeProvider_default, {
    theme: privateTheme,
    children: (0, import_jsx_runtime36.jsx)(ThemeContext.Provider, {
      value: engineTheme,
      children: (0, import_jsx_runtime36.jsx)(RtlProvider_default, {
        value: rtlValue,
        children: (0, import_jsx_runtime36.jsx)(DefaultPropsProvider_default, {
...
function createContainer(options = {}) {
  ...
  const Container2 = React90.forwardRef(function Container3(inProps, ref) {
    ...
    return (
      ...
      (0, import_jsx_runtime39.jsx)(ContainerRoot, {
        as: component,
        ownerState,
...
function isMuiElement2(element, muiNames) {
  var _a, _b, _c;
  return React91.isValidElement(element) && muiNames.indexOf(
...
function createGrid(options = {}) {
  ...
  const Grid2 = React92.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime40.jsx)(GridRoot2, {
      ref,
      as: component,
      ownerState,
      className: clsx_default2(classes.root, className),
      ...
      children: React92.Children.map(children, (child) => {
        var _a;
        if (React92.isValidElement(child) && isMuiElement2(child, ["Grid"]) && container && child.props.container) {
...
function createStack(options = {}) {
  ...
  const Stack2 = React93.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
    ...
    return (0, import_jsx_runtime41.jsx)(StackRoot, {
      as: component,
      ownerState,
      ref,
      className: clsx_default2(classes.root, className),
...
function ChartsItemTooltipContent(props) {
  ...
  const {
    zAxis,
    zAxisIds
  } = React95.useContext(ZAxisContext);
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axis: import_prop_types40.default.object.isRequired,
  /**
   * Data identifying the triggered axis.
   */
  axisData: import_prop_types40.default.shape({
    x: import_prop_types40.default.shape({
      index: import_prop_types40.default.number,
      value: import_prop_types40.default.oneOfType([import_prop_types40.default.instanceOf(Date), import_prop_types40.default.number, import_prop_types40.default.string]).isRequired
    }),
    y: import_prop_types40.default.shape({
      index: import_prop_types40.default.number,
      value: import_prop_types40.default.oneOfType([import_prop_types40.default.instanceOf(Date), import_prop_types40.default.number, import_prop_types40.default.string]).isRequired
    })
  }).isRequired,
   ...
   */
  axisValue: import_prop_types40.default.oneOfType([import_prop_types40.default.instanceOf(Date), import_prop_types40.default.number, import_prop_types40.default.string]),
  /**
   * Override or extend the styles applied to the component.
   */
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React97.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React97.useMemo(() => {
...
function ChartsTooltip(inProps) {
  ...
  const {
    item,
    axis
  } = React98.useContext(InteractionContext);
...
function LegendPerItem(props) {
  ...
  const theme = useTheme();
  const drawingArea = useDrawingArea();
  const labelStyle = React102.useMemo(
  ...
  const padding2 = React102.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React102.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React102.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React102.useMemo(() => {
...
true ? DefaultChartsLegend.propTypes = {
   ...
   */
  drawingArea: import_prop_types42.default.shape({
    bottom: import_prop_types42.default.number.isRequired,
    height: import_prop_types42.default.number.isRequired,
    left: import_prop_types42.default.number.isRequired,
    right: import_prop_types42.default.number.isRequired,
  ...
  series: import_prop_types42.default.object.isRequired,
  seriesToDisplay: import_prop_types42.default.arrayOf(import_prop_types42.default.shape({
    ...
    itemId: import_prop_types42.default.oneOfType([import_prop_types42.default.number, import_prop_types42.default.string]),
    label: import_prop_types42.default.string.isRequired,
    maxValue: import_prop_types42.default.oneOfType([import_prop_types42.default.instanceOf(Date), import_prop_types42.default.number]),
    minValue: import_prop_types42.default.oneOfType([import_prop_types42.default.instanceOf(Date), import_prop_types42.default.number]),
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime51.jsxs)(React106.Fragment, {
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'middle'
   */
  align: import_prop_types44.default.oneOf(["end", "middle", "start"]),
  /**
   ...
   * @default '50%'
   */
  length: import_prop_types44.default.oneOfType([import_prop_types44.default.number, import_prop_types44.default.string]),
  /**
   ...
   */
  maxLabel: import_prop_types44.default.oneOfType([import_prop_types44.default.func, import_prop_types44.default.string]),
  /**
   * The label to display at the minimum side of the gradient.
   * Can either be a string, or a function.
   * @default ({ formattedValue }) => formattedValue
   */
  minLabel: import_prop_types44.default.oneOfType([import_prop_types44.default.func, import_prop_types44.default.string]),
  /**
   * The position of the legend.
   */
   ...
   * @default 'linear'
   */
  scaleType: import_prop_types44.default.oneOf(["linear", "log", "pow", "sqrt", "time", "utc"]),
  /**
   * The space between the gradient bar and the labels.
   * @default 4
   */
  spacing: import_prop_types44.default.number,
  /**
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default 'z'
   */
  axisDirection: import_prop_types45.default.oneOf(["x", "y", "z"]),
  /**
   * The id of the axis item with the color configuration to represent.
   * @default The first axis item.
   */
  axisId: import_prop_types45.default.oneOfType([import_prop_types45.default.number, import_prop_types45.default.string]),
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   * The default depends on the chart.
   */
  direction: import_prop_types45.default.oneOf(["column", "row"]).isRequired,
  /**
   * Hide the first item of the legend, corresponding to the [-infinity, min] piece.
   * @default false
   */
  hideFirst: import_prop_types45.default.bool,
  /**
   * Hide the last item of the legend, corresponding to the [max, +infinity] piece.
   * @default false
   */
  hideLast: import_prop_types45.default.bool,
  /**
   * Space between two legend items (in px).
   * @default 10
   */
   ...
   */
  labelFormatter: import_prop_types45.default.func,
  /**
   * Style applied to legend labels.
   * @default theme.typography.subtitle1
   */
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime53.jsxs)(React108.Fragment, {
...
function ChartsClipPath(props) {
  ...
  return (0, import_jsx_runtime54.jsx)("clipPath", {
    id,
    children: (0, import_jsx_runtime54.jsx)("rect", {
      x: left2 - offset.left,
      y: top2 - offset.top,
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime57.jsx)(React112.Fragment, {
    children: xTicks.map(({
      value,
      offset
    }) => (0, import_jsx_runtime57.jsx)(GridLine, {
      y1: drawingArea.top,
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime58.jsx)(React113.Fragment, {
    children: yTicks.map(({
      value,
      offset
...
function ChartsGrid(inProps) {
  ...
  return (0, import_jsx_runtime59.jsxs)(GridRoot, _extends({}, other, {
    className: classes.root,
    children: [vertical && (0, import_jsx_runtime59.jsx)(ChartsGridVertical, {
      axis: verticalAxis,
      drawingArea,
      classes
    }), horizontal && (0, import_jsx_runtime59.jsx)(ChartsGridHorizontal, {
      axis: horizontalAxis,
      drawingArea,
      classes
    })]
...
function ChartsOnAxisClickHandler(props) {
  ...
  return (0, import_jsx_runtime60.jsx)(React115.Fragment, {});
}
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime61.jsx)(StyledText, _extends({
    x: left2 + width2 / 2,
    y: top2 + height2 / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime62.jsx)(StyledText2, _extends({
    x: left2 + width2 / 2,
    y: top2 + height2 / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime63.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime63.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
var LineChart = React119.forwardRef(function LineChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiLineChart"
  });
  ...
  return (0, import_jsx_runtime64.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime64.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), (0, import_jsx_runtime64.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime64.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime64.jsx)(AreaPlot, _extends({}, areaPlotProps)), (0, import_jsx_runtime64.jsx)(LinePlot, _extends({}, linePlotProps)), (0, import_jsx_runtime64.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime64.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
    })), (0, import_jsx_runtime64.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime64.jsx)("g", {
      "data-drawing-container": true,
      children: (0, import_jsx_runtime64.jsx)(MarkPlot, _extends({}, markPlotProps))
    }), (0, import_jsx_runtime64.jsx)(LineHighlightPlot, _extends({}, lineHighlightPlotProps)), (0, import_jsx_runtime64.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime64.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime64.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
true ? LineChart.propTypes = {
   ...
   */
  disableLineItemHighlight: import_prop_types52.default.bool,
  /**
   * If `true` marks will render `<circle />` instead of `<path />` and drop theme override for faster rendering.
   */
  experimentalMarkRendering: import_prop_types52.default.bool,
  /**
   ...
   */
  onAreaClick: import_prop_types52.default.func,
  /**
   * The function called for onClick events.
   * The second argument contains information about all line/bar elements at the current mouse position.
   * @param {MouseEvent} event The mouse event recorded on the `<svg/>` element.
   ...
   */
  onLineClick: import_prop_types52.default.func,
  /**
   * Callback fired when a mark element is clicked.
   */
  onMarkClick: import_prop_types52.default.func,
  /**
   * The chart will try to wait for the parent container to resolve its size
   * before it renders for the first time.
   *
